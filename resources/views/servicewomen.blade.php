...
<body class="bg-[#023A15]" style="overflow-x: hidden; width: 100%">
    <nav class="flex flex-wrap items-center justify-between py-4">
        ...
        <div class="flex gap-[70px] text-white">
            ...
            <a class="text-white/[0.4]" href="">Service</a>
            ...
            <div class="flex mx-[129px] justify-evenly flex-col">
                ...
                <div>
                    <p style="font-family: 'Montserrat', sans-serif;" class="text-white text-lg">“Saya mengambil hair cut.
                        “Saya mengambil hair coloring dan hair cut. Permasalahan yang saya hadapi adalah warna rambut saya yang sangat menguning dari sisa bleaching dan saya menginginkan warna rambut yang cukup terang namun tidak memungkinkan bagi rambut saya untuk dibleaching kembali. </div>
                <div class="flex place-content-between flex-row ">
                    <div class="">
                        <h1 style="font-family: 'Cormorant', sans-serif;" class="text-2xl">Veronica Jane</h1>
