...
<body class="bg-[#023A15]" style="overflow-x: hidden; width: 100%">
    <nav class="flex flex-wrap items-center justify-between py-4">
        ...
        <div class="flex gap-[70px] text-white">
            ...
            <a href="/bag" class="text-white/[0.4]">Shopping Cart</a>
...
<body class="bg-[#023A15]">
    ...
    <div class="bg-[#fdf6f3] w-full h-full py-24">
        <h1 class="font-cormorant w-[600px] text-center mx-auto text-[100px]">Thank You For Your Feedback!</h1>
            <div
                ...
                YOU EARNED: 50 POIN</div>
        <div class="flex justify-center mt-6">
            <a class="font-montserrat hover:underline-offset-4 underline " href="/home">Back to Home</a>
        </div>
