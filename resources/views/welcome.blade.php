...
<body class="bg-[#023A15]" style="overflow-x: hidden; width: 100%">
    <nav class="flex flex-wrap items-center justify-between py-4">
        ...
        <div class="flex items-center mr-12 gap-4 text-white">
            <a href="{{ config('app.url')}}:8000/register">Sign Up</a>
            <a style="padding: 10px 30px; background-color:  #567C49; border-radius: 20px" href="{{ config('app.url')}}:8000/login">Login</a>
        </div>
    </nav>
    <!-- start content -->
    ...
    <!-- 2nd content -->
    <div class="bg-[#FDF5F3] flex" style="padding-block: 200px; gap: 40px; justify-content: center; position: relative;">
        <img src="images/main-img1.png" style="width: 300px; object-fit: contain" alt="">
        <div class="flex" style="flex-direction: column; align-items: center; font-family: 'Montserrat';">
            <p style=" color: #023A15; font-weight: bold">Everyone Can Feel the Beaute</p>
            <img src="images/main-text.png" style="object-fit: contain;" alt="">
            <p style="padding-top: 50px; color: #567C49">Click the picture to follow more</p>
        </div>
        <img src="images/main-img2.png" style="width: 300px; object-fit: contain" alt="">
        <img src="images/main-lgreen.png" style="position: absolute; width: 150px; object-fit: contain; left: 50px; top: 25%" alt="">
        <img src="images/main-dgreen.png" style="position: absolute; width: 150px; object-fit: contain; right: 50px; top: 65%" alt="">
