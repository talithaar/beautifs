...
<body class="bg-[#023A15]">
    ...
    <div style="font-family: 'Cormorant', sans-serif;"
        class="text-6xl text-white flex justify-center items-center mt-[118px] pb-24">
        <h1 class="z-20 absolute">Our Service</h1>
        <img class="relative z-10 left-14 w-48" src="nyiksa.svg" alt="">
    </div>
    <div class="bg-[#FDF5F3] text-[#023A15] px-[128px]">
        <div style="font-family: 'Cormorant', sans-serif;" class="text-6xl flex justify-center items-center mt-12">
            <h1 class="z-20 absolute">Special Service from Beautifs</h1>
            <img class="relative z-10 left-[246px] w-60 h-64" src="nyiksa.svg" alt="">
        </div>
        <div class="flex justify-center mx-auto w-[565px] text-[#567C49] -mt-12 text-center">
            <p style="font-family: 'Montserrat', sans-serif;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Proin lobortis sed sapien in pretium. Donec tincidunt, quam.</p>
        </div>
        <div class="flex flex-row justify-center gap-20 mt-20">
            <div class="w-[406px]">
                <img class="w-[406px] h-[475px] z-10 rounded-t-full"
                    src="https://img.freepik.com/premium-photo/good-looking-hipster-young-bearded-man-visiting-hairstylist-barber-shop_473712-4586.jpg"
                    alt="">
                <div class="w-[362px] z-20 -translate-y-10 mx-auto h-[206px] bg-white">
                    <h1 style="font-family: 'Cormorant', sans-serif;"
                        class="text-[#023A15] font-light pt-3 mb-4 flex justify-center text-5xl z-20">Haircut</h1>
                    <p style="font-family: 'Montserrat', sans-serif;" class="text-[#567C49] flex justify-center">
                        Potongan Sesuai Keinginan</p>
                    <a href=""
                        class="flex text-[#319E48] font-semibold underline underline-offset-2 justify-center mt-12">LEARN MORE ‎<i class="fa-solid fa-arrow-right flex items-center"></i></a>
                </div>
            </div>
            <div class="w-[406px]">
                <img class="w-[406px] h-[475px] z-10 rounded-t-full"
    ...
    <div class="w-full relative flex text-white flex-row">
        <img class="w-1/2 h-[1062px]"
            src="https://cdn.popbela.com/content-images/post/20180926/selfie-7-4b13ba115dee79800ebc82bffd5dc931.jpg"
            alt="">
        <div class="flex mx-[129px] justify-evenly flex-col">
            <h1 class="text-[80px] mt-12  text-white" style="font-family: 'Cormorant', sans-serif;"> Review From Our
                Customer
            </h1>
            <img class="mr-auto" src="nyiksa2.svg" alt="">
            <div>
                <p style="font-family: 'Montserrat', sans-serif;" class="text-white text-lg">“Saya mengambil hair cut.
                    hasil hair cut sangat memuaskan, sesuai dengan keinginan saya.”</p>
            </div>
            <div class="flex place-content-between flex-row ">
                <div class="">
                    <h1 style="font-family: 'Cormorant', sans-serif;" class="text-2xl">Joko wiiiiii</h1>
                    <p style="font-family: 'Montserrat', sans-serif;">Customer</p>
                </div>
                <div class="flex flex-row  gap-4">
                    <!-- ini mau di next ya cuman gw statis aja ya ga carousel saran ilangin aja atau ga klo mau nambah ya gpp-->
                    <button>
                        <svg width="64" height="20" viewBox="0 0 64 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M64 9.83887L1 9.83887" stroke="white" stroke-width="2" stroke-miterlimit="10" />
                            <path d="M10 0.936243L0.999999 9.83897L10 18.7417" stroke="white" stroke-width="2"
    ...
    <footer style="font-family: 'Montserrat', sans-serif;"
        ...
        <div class="flex flex-col">
            <img class="w-[285px]" src="logotal.svg" alt="">
