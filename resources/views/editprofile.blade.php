...
<body class="bg-[#023A15]" style="overflow-x: hidden; width: 100%">
    ...
    <div class="flex justify-center items-center py-32 relative bg-[#3c634a] text-6xl w-full h-full font-cormorant">
        <h1 class="text-white relative z-10">Edit Profile</h1>
        <img class="absolute w-80 z-0" src="images/nyiksa.svg" alt="">
    </div>

    <div class="bg-[#FDF5F3] w-full h-full p-16">
        <form action="">
            <div class="flex flex-col">
                <h1 class="font-cormorant text-[#023A15] text-5xl">Profile</h1>
                <img class="w-[123px] -translate-y-3" src="images/line.svg" alt="">
            </div>
            <div class="flex flex-row ml-4 items-center gap-6">
                <img class="w-28" src="https://www.simplilearn.com/ice9/free_resources_article_thumb/what_is_image_Processing.jpg" alt="">
                <a class="ring-black ring-1 w-28 h-12 rounded-full flex items-center justify-center" href="">Change</a>
            </div>
            <div class="flex flex-col gap-8 mt-8">
                <div class="flex gap-8 flex-row">
                    <div class="relative">
                        <input
                            class="w-[600px] h-20 rounded-full bg-transparent ring-1 text-xl placeholder:text-black ring-black pl-8 pt-2 focus:outline-none"
                            type="text" placeholder="Talitha">
                        <p class="absolute top-0 left-8">First Name</p>
                    </div>
                    <div class="relative">
                        <input
                            class="w-[600px] h-20 rounded-full bg-transparent ring-1 text-xl placeholder:text-black ring-black pl-8 pt-2 focus:outline-none"
                            type="text" placeholder="Aurelia">
                        <p class="absolute top-0 left-8">Last Name</p>
                    </div>
                </div>
            </div>
            <div class="flex flex-col gap-8 mt-8">
                <div class="flex gap-8 flex-row">
                    <div class="relative">
                        ...
                        <p class="absolute top-0 left-8">Nick Name</p>
                    </div>
                </div>
            </div>
            <div class="flex flex-col gap-8 mt-8">
                <div class="flex gap-8 flex-row">
                    <div class="relative">
                        <input
                            class="w-[600px] h-20 rounded-full bg-transparent ring-1 text-xl placeholder:text-black ring-black pl-8 pt-2 focus:outline-none"
                            type="text" placeholder="talithaarr@gmail.com">
                        <p class="absolute top-0 left-8">Email</p>
                    </div>
                    <div class="relative">
                        <input
                            class="w-[600px] h-20 rounded-full bg-transparent ring-1 text-xl placeholder:text-black ring-black pl-8 pt-2 focus:outline-none"
                            type="text" placeholder="">
                        <p class="absolute top-0 left-8">Phone</p>
                    </div>
                </div>
            </div>
            <div class="flex flex-col gap-8 mt-8">
                <div class="flex gap-8 flex-row">
                    <div class="relative">
                        <input
                            class="w-[600px] h-20 rounded-full bg-transparent ring-1 text-xl placeholder:text-black ring-black pl-8 pt-2 focus:outline-none"
                            type="text" placeholder="">
                        <p class="absolute top-0 left-8">City</p>
                    </div>
                    <div class="relative">
                        <input
                            class="w-[600px] h-20 rounded-full bg-transparent ring-1 text-xl placeholder:text-black ring-black pl-8 pt-2 focus:outline-none"
                            type="text" placeholder="">
                        <p class="absolute top-0 left-8">State</p>
                    </div>
                </div>
            </div>
            <div class="relative mt-8">
                <input
                    class="w-[1210px] h-28 rounded-2xl bg-transparent ring-1 text-xl placeholder:text-black ring-black pl-12 pt-6 focus:outline-none"
                    type="text" placeholder="">
                <p class="absolute top-3 left-12">Alamat</p>
            </div>
            <div class="flex justify-center mt-12">
                <a href="/home">
                    <div class="w-[600px] h-20 bg-white flex justify-between px-12 items-center rounded-full">
                        <h1 class="mx-auto">Save Changes</h1>
                        <svg width="64" height="20" viewBox="0 0 64 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 10.0342H63" stroke="black" stroke-width="2" stroke-miterlimit="10" />
                            <path d="M54 18.973L63 10.0343L54 1.0957" stroke="black" stroke-width="2"
