...
<body class="bg-[#023A15]" style="overflow-x: hidden; width: 100%">
    <nav class="flex flex-wrap items-center justify-between py-4">
        ...
        <div class="flex gap-[70px] text-white">
            <a href="/home">Home</a>
            <a class="text-white/[0.4]" href="">About</a>
    ...
    <div class="bg-[#023A15] flex items-center justify-center h-72">
        <img src="images/nyiksa.svg" alt="" class="absolute z-0 w-[200px] md:w-[220px] -ml-20">
    ...
    <div class="bg-[#fdf6f3]  py-32 px-[117px]  h-full relative w-full">
        <div class="flex flex-row z-10 relative justify-between items-center ">
            <div>
                    <img class="w-[455px] h-[666px]" src="images/plholder.png" alt="">
            </div>
            <div class="flex flex-col space-y-12 leading-loose justify-center items-center text-[#023A15] text-center">
                <div class="flex flex-col justify-center items-center text-6xl md:text-6xl font-medium">
                    ...
                    <div>
                        <img src="images/nyiksa.svg" alt="" class="absolute z-0 w-[270px] md:w-[250px] -ml-7 lg:-ml-5 xl:-ml-5 xl:mt-0">
                        <h1 class="font-cormorant">masculine and</h1>
                    </div>
                    <div>
                        <img src="images/nyiksa.svg" alt="" class="absolute z-0 w-[270px] md:w-[250px] -ml-7 lg:-ml-10 xl:-ml-10 xl:mt-0">
                ...
                <div>
                    <img src="images/sign.png" alt="sign" class="mb-1.5">
                    <h1 class="text-lg whitespace-nowrap text-[#567C49] font-medium">Founder & CEO of Chloro</h1>
                </div>
            </div>
            <div>
                    <img class="w-[455px] h-[666px] font-montserrat" src="images/plholder2.png" alt="">
            </div>
    ...
    <div class="bg-[#FDF5F3] py-10 px-10 lg:px-20 xl:px-44">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-7 mb-10">
            ...
            <div class="relative">
                ...
                <div class="text-center absolute bottom-0 left-0 right-0 px-5">
                    <div class="bg-white py-4 lg:py-7">
                        <h1 class="text-2xl lg:text-4xl font-cormorant text-[#023A15] mb-2 lg:mb-4">Kate Amanda</h1>
                        <h1 class="text-xs lg:text-lg text-[#567C49] font-medium mb-4">Specialist</h1>
                        <div class="flex justify-center space-x-5">
                            <a href="#" class="flex items-center rounded-full p-2 text-white text-center text-xl bg-[#023A15]">
                                <ion-icon name="logo-whatsapp"></ion-icon>
