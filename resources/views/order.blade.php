...
<body class="bg-[#023A15]" style="overflow-x: hidden; width: 100%">
    ...
    <div class="flex justify-center items-center my-32 relative text-6xl w-full h-full font-cormorant">
        <h1 class="text-white relative z-10">Our Service</h1>
        <img class="absolute w-52 z-0 right-[39.5%]" src="images/circ.svg" alt="">
    </div>
    <!-- 2nd content -->
    <div class="bg-[#FDF5F3] text-[#023A15] w-full h-full">
        <div class="flex flex-row h-full gap-8 p-32">
            <div class="flex flex-col">
                <h1 class="font-cormorant text-xl">Categories</h1>
                <hr class="outline-none  w-64 bg-[#023A15]">
                <div class="flex flex-row mt-2 items-center justify-between">
                    <h1 class="font-montserrat">Woman</h1>
                    <i class="fa fa-arrow-down" style="color: #023A15;"></i>
                </div>
                <div class="flex gap-1 flex-col ml-8">
                    <div class="flex flex-row font-montserrat justify-between">
                        <p>Skincare</p>
                        <div
                            class="w-5 h-5 text-sm rounded-full text-white flex justify-center items-center bg-[#023A15]">
                            5
                        </div>
                    </div>
                    <div class="flex flex-row font-montserrat justify-between">
                ...
                <div class="flex flex-row mt-2 items-center justify-between">
                    <h1 class="font-montserrat">Man</h1>
                </div>
                <div class="flex gap-1 flex-col ml-8">
                    <div class="flex flex-row font-montserrat justify-between">
                        <p>Hair</p>
                ...
                <div class="mt-12 flex flex-col gap-1">
                    <h1 class="font-cormorant text-xl">Price</h1>
                    <hr class="outline-none  w-64 bg-[#023A15]">
                    <div class="mt-4">
                        <img class="w-3/4" src="images/linedetails.svg" alt="">
                        <p class="font-montserrat text-sm mt-4">Range : Rp 0 - Rp 1.000.000</p>
                    </div>
                </div>
            </div>
            <div class="flex flex-col">
                <div class="flex flex-row w-full items-center mr-52 justify-between text-[#567C49]">
                    <div class="font-montserrat">
                        <p class="w-[250px]">Showing 1-12 of 100 item(s)
                            in Woman</p>
                    </div>
                    <div class="flex items-center gap-8">
                        <div>
                            <a href="/bag">
                            <img class="w-4 mt-1 h-4" src="images/bag.svg" alt="">
                        </div>
                        <a href="">
                            <div
                                class="bg-[#023A15] rounded-full font-montserrat w-52 h-12 flex items-center justify-center gap-3 font-semibold uppercase text-white">
                                Default Sorting <i class="fa fa-arrow-down" style="color: white;"></i>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="grid grid-cols-3 mt-5 gap-x-20">
                    <div class="w-[245px]">
                        <img class="w-[245px] h-[300px] z-10 rounded-t-full" src="images/details.png" alt="">
                        <div class="w-[214px] z-20 -translate-y-10 mx-auto h-[129px] bg-white">
                            <h1 style="font-family: 'Cormorant', sans-serif;"
                                class="text-[#023A15] font-light pt-3  flex justify-center text-4xl z-20">Face Scrub
                            </h1>
                            <p style="font-family: 'Montserrat', sans-serif;"
                                class="text-[#567C49] text-sm flex justify-center">
                                start form</p>
                            <p style="font-family: 'Montserrat', sans-serif;"
                                class="text-[#567C49] text-sm flex justify-center">
                                IDR 289.000</p>
                            <a href=""
                                class="flex text-[#319E48] font-medium underline underline-offset-2 justify-center ">GET
                                TO BAG ‎<i class="fa-solid fa-arrow-right flex items-center"></i></a>
                        </div>
                    </div>
                    <div class="w-[245px]">
                        <img class="w-[245px] h-[300px] z-10 rounded-t-full" src="images/face-mas.png" alt="">
                        <div class="w-[214px] z-20 -translate-y-10 mx-auto h-[129px] bg-white">
                            <h1 style="font-family: 'Cormorant', sans-serif;"
                                class="text-[#023A15] font-light pt-3  flex justify-center text-4xl z-20">Face Scrub
                            </h1>
        ...
        <div class="flex font-montserrat gap-8 flex-row text-2xl items-center py-8 justify-center">
            <a href="">
                <svg class="" width="64" height="20" viewBox="0 0 64 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M64 10.0347L1 10.0347" stroke="#023A15" stroke-width="2" stroke-miterlimit="10" />
                    <path d="M10 1.09586L0.999999 10.0345L10 18.9731" stroke="#023A15" stroke-width="2"
                        stroke-miterlimit="10" stroke-linejoin="bevel" />
                </svg>
            </a>
            <a href="">1</a>
            <a class="text-[#567C49]/[0.48]" href="">2</a>
            <a class="text-[#567C49]/[0.48]" href="">3</a>
            <a class="text-[#567C49]/[0.48]" href="">...</a>
            <a class="text-[#567C49]/[0.48]" href="">10</a>
        ...
        <div class="flex flex-col">
            ...
            <div class="flex mt-4 flex-row gap-[145px]">
                <div class="flex flex-col gap-[50px] w-[476px]">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin lobortis sed sapien in
                        pretium.
                    </p>
