...
<body class="bg-[#023A15]" style="overflow-x: hidden; width: 100%">
    <nav class="flex flex-wrap items-center justify-between py-4">
        ...
        <div class="flex gap-[70px] text-white">
            <a class="text-white/[0.4]" href="">Home</a>
            <a href="/about">About</a>
            <a href="/service" class="">Service</a>
            <a href="/order">Order</a>
            <a href="/bag">Shopping Cart</a>
    ...
    <div class="flex items-center relative text-6xl w-full h-full font-cormorant" style="padding-block: 140px;  justify-content: space-around; position: relative;">
        <div class=" flex" style="flex-direction: column; gap: 20px;">
            <img src="images/head-text.png" style="width: 500px" alt="">
            <p style="font-size: 15px; font-family: 'Montserrat'; color: white">Self-care:<br>
                You are the one who defines your own beauty, not society out <br>there.</p>
            <div class="flex justify-center my-auto items-center rounded-full w-[270px] h-16 bg-white text-[#023A15] text-[25px] " style="font-family: 'Montserrat'; font-weight: bold">
                YOUR POIN: 100
            </div>
        </div>
        <div class="" style="display: flex; gap: 10px; flex-direction: row; z-index: 1">
            <img src="images/head-hero1.png" style="width: 300px; height: 420px;" alt="">
            <img src="images/head-hero2.png" style="width: 300px; height: 420px;" alt="">
            <img src="images/head-hero3.png" style="width: 50px; height: 420px;" alt="">
        </div>
        <img src="images/comp1.png" style="position: absolute; z-index: 0; top: 70%" alt="">
        <img src="images/comp1.png" style="position: absolute; z-index: 1; right: -5%; top: 90%; width: 300px" alt="">
    </div>
    <!-- 2nd content -->
    <div class="bg-[#fdf6f3]  py-32 px-[117px]  h-full relative w-full">
        <div class="flex flex-row z-10 relative justify-between items-center ">
            <div>
                <a href="/serviceman">
                    <img class="w-[455px] h-[469px]" src="images/cnt-2.png" alt="">
                </a>
            </div>
            <div class="flex flex-col w-1/2 gap-12 items-center">
                <h1 class="font-montserrat text-[#023A15] text-sm">Everyone Can Feel the Beaute</h1>
                <div class="relative">
                    <h1 class="font-cormorant tracking-wide text-[#023A15] text-6xl text-center">Are you
                        <br>
                        men or women
                    </h1>
                    <img class="w-36  -left-6 absolute bottom-2" src="images/circ.svg" alt="">
                    <img class="w-52  -right-3 absolute bottom-1" src="images/circ.svg" alt="">

                </div>
                <p>Click the picture to follow more</p>
            </div>
            <div>
                <a href="/servicewomen">
                    <img class="w-[455px] h-[469px] font-montserrat" src="images/cnt-1.png" alt="">
                </a>
            </div>
            <img class="absolute z-0 -top-16 w-56 rotate-[162deg]" src="images/halfcirc.svg" alt="">
            <img class="absolute z-0 -right-[117px] -top-[40%] w-56 " src="images/halfcirc-ovr.svg" alt="">
            <img class="absolute z-0 -right-24 -bottom-16 w-56 " src="images/halfcirc-b.svg" alt="">
        </div>
    </div>
    <div class="bg-[#DED4D1] flex" style="padding-block: 200px; justify-content: center; position: relative; align-items: center">
        <img src="images/ourstory.png" style="width: 600px; object-fit: contain"  alt="">
        <div class="flex flex-col" style="width: 500px; height: 400px; background-color: #023A15; margin-left: -100px; justify-content: center; padding: 100px 50px; margin-top: -100px">
            <h1 style="font-size: 50px; color: white; font-family: 'Cormorant'">Our Story</h1>
            <p style=" font-size: 15px;font-family: 'Montserrat'; color: white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure doloremque commodi eligendi cupiditate pariatur dignissimos nesciunt ratione illum quibusdam est. Ullam alias aperiam rem blanditiis consectetur impedit quam, iure natus.</p>
            <button style=" width: 200px; padding: 10px 15px; border: none; background-color: white; color: black; margin-block: 25px; border-radius: 20px; font-weight: 600">READ MORE</button>
        </div>
        <div class="flex" style="position: absolute; top: 65%;right: 8%; padding: 30px 100px; gap: 110px; ">
            <div class="left-ourstory flex" style="justify-content: center; align-items: center; flex-direction: column">
                <p style="font-size: 45px; font-family: 'Cormorant'; color: #023A15;">955+</p>
                <p style="font-size: 12px; font-family: 'Montserrat'; font-weight: bold; color: #319E48">Happy Customer</p>
            </div>
            <div class="left-ourstory flex" style="justify-content: center; align-items: center; flex-direction: column">
                <p style="font-size: 45px; font-family: 'Cormorant'; color: #023A15;">240+</p>
                <p style="font-size: 12px; font-family: 'Montserrat'; font-weight: bold; color: #319E48">Happy Customer</p>
            </div>
        </div>
        <img src="images/main-dgreen.png" style="position: absolute; width: 200px; object-fit: contain; left: 150px; top: 25%; transform: rotate(180deg);" alt="">
        <img src="images/main-lgreen.png" style="position: absolute; width: 200px; object-fit: contain; right: 50px; top: 55%; transform: rotate(180deg);" alt="">
    </div>
    <div class="bg-[#023A15] flex" style=" position: relative; width: 100%">
        <div class="flex" style="justify-content: center; align-items: center; width: 60%">
            <div class="flex" style="flex-direction: column; justify-content: center; align-items: center; padding: 50px 100px; height: 70%; gap: 20px;">
                <p style="font-size: 50px; color: white; font-family: 'Cormorant';">Review From Our Customer</p>
                <p style="font-size: 17px; color: white; font-family: 'Montserrat';">“Hai, kebetulan aku punya rambut yang panjang, aku terakhir potong rambut itu bulan November tahun lalu. Terus aku sudah bosen sama rambut aku jadinya ya aku memutuskan untuk cari salon yang oke. Kebetulan, aku dikasih kesempatan nih sama Yukcoba.in buat potong rambut di Chandra Gupta Hair & Beauty Salon yang ada di Mall Taman Anggrek. Pas datang ke sana, salonnya lagi ramai pengunjung tapi bersih enggak kelihatan berantakan. Jadi emang di sana kalau ada sampah sedikit aja langsung dibersihin jadi para pengunjungnya nyaman.”</p>
                <div class="flex" style="flex-direction: column; width: 100%; justify-content: left;">
                    <p style="font-size: 20px; color: white; justify-content: unset; font-family: 'Cormorant">Nycki Kimso</p>
                    <p style="font-size: 15px; color: white; justify-content: unset">Customer</p>
                </div>
            </div>
        </div>
        <img src="images/review.png" style="width: 40%; height: 100%;; object-fit: contain;" alt="">
    </div>
    <div class="bg-[#fff] flex" style="padding-block: 100px; justify-content: center; position: relative; align-items: center; gap: 20px">
        <div class="flex" style="flex-direction: column; gap: 20px; width: 40%">
            <img src="images/info_1.png" style="width: 500px; object-fit: contain;" alt="">
            <img src="images/info_2.png" style="width: 500px; object-fit: contain;" alt="">
        </div>
        <div class="flex" style="flex-direction: column; justify-content: space-around;height: 100%; width: 40%; gap: 20px; line-height: 20px">
            <img src="images/textinfo_1.png" style="width: 400px" alt="">
            <p style="font-size: 15px; width: 400px">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin lobortis sed sapien in pretium. Donec tincidunt, quam vestibulum ultricies egestas, dolor sem laoreet orci, quis finibus justo quam at nibh. Vestibulum ipsum tortor, suscipit non enim vitae.
                Tincidunt scelerisque augue. Nunc quis fringilla magna, vel sollicitudin quam.</p>
            <ol class="custom-list">
                <li class="image-list"><span>Cnsectetur adipiscing elit.</span></li>
                <li class="image-list"><span>Proin lobortis sed sapien.</span></li>
                <li class="image-list"><span>Donec tincidunt, quam.</span></li>
                <li class="image-list"><span>Vestibulum ipsum tortor.</span></li>
            </ol>
            <div class="">
                <button style="padding: 20px 40px; border: none; background-color: #023A15; display: block; font-weight: bold; border-radius: 40px; color: white">LEARN MORE</button>
            </div>
        </div>
        <img src="images/main-dgreen.png" style="position: absolute; transform: rotate(180deg); width: 150px; left: 5%; top: 5%" alt="">
    </div>
