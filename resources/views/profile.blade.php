...
<body class="bg-[#023A15]" style="overflow-x: hidden; width: 100%">
    ...
    <div class="flex justify-center items-center my-32 relative text-6xl w-full h-full font-cormorant">
        <h1 class="text-white relative z-10">My Profile</h1>
        <img class="absolute w-72 z-0" src="images/circ.svg" alt="">
    </div>
    <!-- 2nd content -->
    <div class="bg-[#FDF5F3] pt-20 px-24 flex flex-col">
        <div class="rounded-[10px] bg-[#567C49]/[0.48] w-full h-[500px]">
            <div class="relative">
            <img class="rounded-t-[10px]" src="images/placeholder-profile.png" alt="">
            <a class="absolute bottom-3 right-3" href="">
                <div class="w-32 h-12 z-10 rounded-full flex justify-center items-center  bg-[#023A15]/[0.40] ">
                    <h1 class="opacity-100 text-white z-0">Edit Cover</h1>
                </div>
            </a>
            </div>
            <div class="flex flex-row justify-between px-12">
                <div class="flex flex-row gap-12">
                <img class="w-48 -translate-y-12" src="images/prof-pic.png" alt="">
                <div class="flex flex-col gap-3 justify-center items-start font-montserrat">
                    <h1 class="text-[#023A15] text-4xl font-semibold">Pengguna 1</h1>
                    <p class="text-[#597b5b] text-2xl">Member</p>
                    <a class="w-56 h-12 bg-[#023A15]/[0.7] rounded-full text-white flex justify-center items-center" href="">Log Out</a>
                </div>
                </div>
                <a class="bg-[#FFDA69] w-40 text-white mt-16 rounded-lg h-16 flex justify-center items-center" href="">
                    Edit Profile
                </a>
            </div>
        </div>
        <div class="bg-[#3C644A] mt-12 rounded-t-[10px] w-full h-[550px]">
            <h1 class="text-white font-cormorant text-3xl pl-8 py-4">Order again</h1>
            <div class="flex flex-row gap-12 mx-12">
                <div class="relative">
                    <img class="w-64 h-[350px] rounded-t-full" src="images/cares.png" alt="">
                    <div
                        class="w-56 h-12 bg-white mx-auto flex justify-center items-center font-cormorant text-[#023A15] -translate-y-5">
                        <h1 class="text-2xl">Mask</h1>
                    </div>
                </div>
                <div class="relative">
                    <img class="w-64 h-[350px] rounded-t-full" src="images/cnt-1.png" alt="">
                    <div
                        class="w-56 h-12 bg-white mx-auto flex justify-center items-center font-cormorant text-[#023A15] -translate-y-5">
                        <h1 class="text-2xl">Mask</h1>
                    </div>
                ...
                <div class="relative">
                    <img class="w-64 h-[350px] rounded-t-full" src="images/details.png" alt="">
                    <div
                        class="w-56 h-12 bg-white mx-auto flex justify-center items-center font-cormorant text-[#023A15] -translate-y-5">
                        <h1 class="text-2xl">Mask</h1>
                    </div>
                </div>
                <div class="flex justify-center my-auto items-center rounded-full w-[270px] h-16 bg-white text-[#023A15] text-[25px] ">
                    YOUR POIN: 100
                </div>
            </div>
        </div>
    ...
    <div class=" px-[130px] bg-red-200 py-12">
