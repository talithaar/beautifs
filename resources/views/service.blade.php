...
<body class="bg-[#023A15]">
    ...
    <div class="flex flex-row gap-20 w-full relative z-10 my-24 bg-[#023A15]">
        <div class="flex flex-col gap-6 z-10 ml-[207px]">
            <div class="relative">
                <img class="absolute top-3 left-12 w-[404px] z-10" src="images/circ.svg" alt="">
                <h1 class="font-montserrat w-[567px] z-20 italic text-[75px] font-light text-white"> <span
                        class="font-normal font-cormorant z-20 relative not-italic">A whole</span> new world, <span
                        class="font-normal font-cormorant z-20 not-italic">a whole</span> new look</h1>
                <img class="-translate-y-8" src="images/line.svg" alt="">
            </div>

            <div class="font-montserrat text-white w-[566px] text-lg">
                <h1>Self-care:</h1>
                <p class="w-">You are the one who defines your own beauty, not society out there.</p>
            </div>
            <div
                class="flex justify-center items-center rounded-full w-[270px] h-16 bg-white text-[#023A15] text-[25px] ">
                YOUR POIN: 100
            </div>
        </div>
        <div class="flex flex-col swiper z-10 mySwiper">
            <div class="w-full overflow-visible swiper-wrapper ">
                <div class="swiper-slide w-[510px] h-[618px] rounded-t-full">
                    <img src="images/placeholder.png" alt="pc1">
                </div>
                <div class="swiper-slide w-[510px] h-[618px] rounded-t-full">
                    <img src="images/placeholder (1).png" alt="pc1">
                </div>
                <div class="swiper-slide w-[510px] h-[618px] rounded-t-full">
                    <img src="images/placeholder.png" alt="pc1">
                </div>
            ...
            <div class="flex flex-row z-30 -translate-y-48 gap-4">
                <a href="#">
                    <img class="swiper-button-prev-unique" src="images/arrow-l.svg" alt="">
                </a>
                <a href="#">
                    <img class="swiper-button-next-unique" src="images/arrow-r.svg" alt="">
                </a>
            </div>
        </div>
        <img class="absolute bottom-40 translate-x-12 z-0 w-64 left-[50%]" src="images/halfcirc.svg" alt="">
    </div>
    <!-- 2nd section -->
    ...
    <!-- 3rd section -->
    <div class="bg-[#DED4D1]">
        <div class="flex flex-row relative py-32 justify-center w-full ">
            <img class="w-5/12" src="images/woman.png" alt="">
            <div class="flex flex-col pt-28">
                <div class="bg-[#023A15] -translate-x-24 w-[497px] relative h-[428px]">
                    <div class="flex flex-col text-white my-8 mx-[82px]">
                        <h1 class="font-cormorant mt-6 text-6xl">Our Story</h1>
                        <img class="-translate-y-5 translate-x-28 w-32" src="images/line.svg" alt="">
                        <p class="font-montserrat tracking-wider h-[34px] mt-6 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
                            lobortis erat posuere, tincidunt sem at, sagittis
                            dolor. Sed malesuada orci erat, ut interdum lorem rhoncus eu. Donec justo urna, mattis non
                            maximus.</p>
                                <a href="#" class="w-[180px] absolute bottom-12 items-center flex justify-center text-[#023A15] h-[56px] bg-white rounded-full">
                                    Read More <i class="fa fa-arrow-right pl-2"></i>
                                </a>
                    </div>
                </div>
                <div class="flex flex-row mt-12 gap-20 mx-12 font-cormorant">
                    <div class="flex flex-col ">
                        <h1 class="text-[#023A15] text-5xl">955+</h1>
                        <p class="text-[#319E48]">Happy Customer</p>
                    </div>
                    <div class="flex items-center text-center justify-center flex-col">
                        <h1 class="text-[#023A15] text-5xl">240+</h1>
                        <p class="text-[#319E48]">Happy Customer</p>
                    </div>
                </div>
            </div>
            <img class="absolute z-0 bottom-[26%] right-[15%] w-56 rotate-[332deg]" src="images/halfcirc.svg" alt="">
            <img class="absolute z-0 top-[22%] left-[7%] w-56 rotate-[170deg]" src="images/halfcirc-b.svg" alt="">
        </div>
    </div>
    <!-- 4th content -->
    <div class="w-full relative flex text-white flex-row">
        <div class="flex mx-[129px] gap-8 flex-col my-auto">
            <h1 class="text-[80px] mt-12  text-white" style="font-family: 'Cormorant', sans-serif;"> Review From Our
                Customer
            </h1>
            <div>
                <p style="font-family: 'Montserrat', sans-serif;" class="text-white text-lg">“Hai, kebetulan aku punya rambut yang panjang, aku terakhir potong rambut itu bulan November tahun lalu. Terus aku sudah
                bosen sama rambut aku jadinya ya aku memutuskan untuk cari salon yang oke. Kebetulan, aku dikasih kesempatan nih sama
                Yukcoba.in buat potong rambut di Chandra Gupta Hair & Beauty Salon yang ada di Mall Taman Anggrek. Pas datang ke sana,
                salonnya lagi ramai pengunjung tapi bersih enggak kelihatan berantakan. Jadi emang di sana kalau ada sampah sedikit aja
                langsung dibersihin jadi para pengunjungnya nyaman.”</p>
            </div>
            <div class="flex place-content-between flex-row ">
                <div class="">
                    <h1 style="font-family: 'Cormorant', sans-serif;" class="text-2xl">Nikky Kimso</h1>
                    <p style="font-family: 'Montserrat', sans-serif;">Customer</p>
                </div>
            </div>
        </div>
        <img class="w-1/2 h-[1062px]"
            src="images/cares.png" alt="">
        <div class="absolute -bottom-[1px] left-[41%]">
            <svg width="297" height="147" viewBox="0 0 297 147" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M0.0675959 146.252C0.678096 65.5815 66.838 0.308086 148.304 0.278493C229.769 0.2489 295.864 65.4482 296.329 146.17L0.0675959 146.252Z"
                    fill="#567C49" />
            </svg>
        </div>
    </div>
    <div>
<!-- 5th content anjir ini murah banget buat 180rb -->
<div class="flex flex-row py-20 gap-12 justify-center relative items-center bg-[#FDF5F3]">
    <div class="flex flex-col gap-12">
        <img class="w-[490px]" src="images/img-t.png" alt="">
        <img class="w-[490px] -translate-x-12" src="images/img-b.png" alt="">
    </div>
    <div class="flex w-fit flex-col gap-2 relative">
        <h1 class="text-[#023A15] font-cormorant text-6xl z-10 relative w-[500px]">Expert Skincare for Your Beautiful Skin</h1>
        <p class="md:w-[500px] font-montserrat text-sm text-[#567C49]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin lobortis sed sapien in pretium. Donec tincidunt, quam
        vestibulum ultricies egestas, dolor sem laoreet orci, quis finibus justo quam at nibh. Vestibulum ipsum tortor, suscipit
        non enim vitae.
        Tincidunt scelerisque augue. Nunc quis fringilla magna, vel sollicitudin quam.</p>
        <div class="flex flex-col">
            <div class="flex mt-4 gap-3 flex-row">
                <img class="w-4" src="images/check.svg" alt="">
                <p class="md:w-[500px] font-montserrat text-sm text-[#567C49]">Cnsectetur adipiscing elit.</p>
            </div>
            <div class="flex mt-4 gap-3 flex-row">
                <img class="w-4" src="images/check.svg" alt="">
                <p class="md:w-[500px] font-montserrat text-sm text-[#567C49]">Cnsectetur adipiscing elit.</p>
            ...
            <a href="#"
                class="w-[180px] mt-8 items-center flex justify-center text-white h-[56px] bg-[#023A15] rounded-full">
                LEARN MORE <i class="fa fa-arrow-right pl-2"></i>
            </a>
        </div>
        <img class="absolute w-60 top-16 right-44 z-0" src="images/circ.svg" alt="">
        <img class="absolute z-0 top-[-17%] -left-[120%] w-56 rotate-[165deg]" src="images/halfcirc-b.svg" alt="">
    </div>
</div>
    </div>
    <!-- end content -->
    <div class="flex flex-col py-20 items-center justify-center bg-[#3c634a] gap-[62px]">
        <div class=" relative">
            ...
            <img class="absolute bottom-14 left-[42%] w-56" src="images/circ.svg" alt="">
        </div>
