...
<body class="bg-[#023A15]" style="overflow-x: hidden; width: 100%">
    ...
    <div class="bg-[#023A15] flex items-center justify-center h-72">
        <img src="images/nyiksa.svg" alt="" class="absolute z-0 w-[200px] md:w-[220px] ml-56">
    ...
    <div class="bg-[#FDF5F3] p-10">
        <div class="grid grid-cols-1 md:grid-cols-2 px-2">
            <div>
                <a href="/servicewomen">
                <img src="images/serpisw.png" alt="">
                </a>
            </div>
            <div class="flex flex-col justify-center items-center lg:px-20">
                <div class="relative mb-4">
                    <img src="images/nyiksa.svg" alt="" class="absolute z-0 w-[130px] lg:w-[240px] right-0 lg:left-0 top-2 lg:top-0">
        ...
        <div class="grid grid-cols-3 gap-3">
            ...
            <div class="w-full col-span-2">
                <div class="flex space-x-5 pb-3 overflow-x-scroll mb-3">
                    <img src="images/specialist.png" alt="" width="280px" class="rounded-t-full">
                    <img src="images/specialist(2).png" alt="" width="280px" class="rounded-t-full">
                    <img src="images/specialist(3).png" alt="" width="280px" class="rounded-t-full">
                    <img src="images/specialist(4).png" alt="" width="280px" class="rounded-t-full">
                    <img src="images/specialist(5).png" alt="" width="280px" class="rounded-t-full">
                </div>
    ...
    <div class="bg-[#FDF5F3] p-10">
        <div class="grid grid-cols-1 md:grid-cols-2 px-2">
            <div>
                <a href="/serviceman">
                    <img src="images/serpism.png" alt="">
                    </a>
            </div>
            <div class="flex flex-col justify-center items-center lg:px-20">
                <div class="relative mb-4">
